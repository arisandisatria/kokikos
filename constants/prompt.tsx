export default {
    ...
    - Hasilkan 10 resep yang berbeda sesuai dengan bahan-bahan tersebut
    ...
    - Tambahkan gambar banner resep dari ('assets/images/placeholder.png')
        ...
        "recipe": [
          {
            ...
            "banner_image": "assets/images/placeholder.png",
            "estimated_time": "10",
            "budget": "10000",
            "ingredient_match": "90",
