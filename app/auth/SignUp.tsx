  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.card, styles.inputBar]}>
        ...
        <TextInput onChangeText={(value) => setUserAccount(prev => ({...prev, fullname: value}))} style={styles.textInput} placeholderTextColor={Colors.muted} placeholder="Nama Lengkap"/>
      </View>
      ...
      <View style={[styles.card, styles.inputBar, {marginTop: 12}]}>
        ...
        <TextInput onChangeText={(value) => setUserAccount(prev => ({...prev, email: value}))} style={styles.textInput} placeholderTextColor={Colors.muted} placeholder="Email" autoCapitalize="none"/>
      </View>

      <View style={[styles.card, styles.inputBar, {marginTop: 12}]}>
        <Ionicons name="call-outline" size={24} color={Colors.primary} style={styles.icon}/>
        <TextInput onChangeText={(value) => setUserAccount(prev => ({...prev, phone_number: value}))} style={styles.textInput} placeholderTextColor={Colors.muted} placeholder="Nomor Telfon" autoCapitalize="none" keyboardType="phone-pad"/>
      </View>

      <View style={[styles.card, styles.inputBar, {marginTop: 12}]}>
        <Ionicons name="lock-closed-outline" size={24} color={Colors.primary} style={styles.icon}/>
        <TextInput onChangeText={(value) => setUserAccount(prev => ({...prev, password: value}))} style={styles.textInput} placeholderTextColor={Colors.muted} placeholder="Password" autoCapitalize="none" secureTextEntry={isSecured}/>
      ...
      <View style={[styles.card, styles.inputBar, {marginTop: 12}]}>
        <Ionicons name="lock-closed-outline" size={24} color={Colors.primary} style={styles.icon}/>
        <TextInput onChangeText={(value) => setUserAccount(prev => ({...prev, confirm_password: value}))} style={styles.textInput} placeholderTextColor={Colors.muted} placeholder="Konfirmasi Password" autoCapitalize="none" secureTextEntry={isConfirmSecured}/>
